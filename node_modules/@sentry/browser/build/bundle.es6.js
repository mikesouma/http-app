...
var Sentry = (function (exports) {
  ...
  function addExceptionMechanism(event, newMechanism) {
      ...
      exceptionValue0.mechanism = Object.assign(Object.assign(Object.assign({}, defaultMechanism), currentMechanism), newMechanism);
      if (newMechanism && 'data' in newMechanism) {
          const mergedData = Object.assign(Object.assign({}, (_a = currentMechanism) === null || _a === void 0 ? void 0 : _a.data), newMechanism.data);
  ...
  ***************************************************************************** */
  ...
  function getNativeFetchImplementation() {
      ...
      const document = global$3.document;
      let fetchImpl = global$3.fetch;
      // eslint-disable-next-line deprecation/deprecation
  ...
  function sendReport(url, body) {
      const isRealNavigator = Object.prototype.toString.call(global$3 && global$3.navigator) === '[object Navigator]';
      const hasSendBeacon = isRealNavigator && typeof global$3.navigator.sendBeacon === 'function';
      if (hasSendBeacon) {
          // Prevent illegal invocations - https://xgwang.me/posts/you-may-not-know-beacon/#it-may-throw-error%2C-be-sure-to-catch
          const sendBeacon = global$3.navigator.sendBeacon.bind(global$3.navigator);
  ...
  class BaseTransport {
      constructor(options) {
          ...
          if (this.options.sendClientReports && global$4.document) {
              global$4.document.addEventListener('visibilitychange', () => {
      ...
      _flushOutcomes() {
          ...
          const envelopeHeader = JSON.stringify(Object.assign({}, (this.options.tunnel && { dsn: this._api.getDsn().toString() })));
          const itemHeaders = JSON.stringify({
              type: 'client_report',
          });
      ...
      setupOnce() {
          addGlobalEventProcessor((event) => {
              ...
              if (getCurrentHub().getIntegration(UserAgent)) {
                  ...
                  const url = ((_a = event.request) === null || _a === void 0 ? void 0 : _a.url) || ((_b = global$6.location) === null || _b === void 0 ? void 0 : _b.href);
                  const { referrer } = global$6.document || {};
                  const { userAgent } = global$6.navigator || {};
